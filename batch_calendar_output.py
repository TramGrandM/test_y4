...
class BatchCalendarOutput:
    def __init__(self, driver):
        self.driver = driver

    def batch_calender_output(self):
        print("Start BatchCalendarOutput")
        try:
            onclick_value = "openModal('CalendarModal', 'L');"
            ...
            btn_submit = WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable((By.ID,  "submitCalendarBtn"))
            )
            btn_submit.click()
            time.sleep(3)
